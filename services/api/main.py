...
API_TITLE = "MMPose Video Keypoint Extraction API"
API_DESCRIPTION = (
    "Local API for MMPose Video Keypoint Extraction: ingest video/frame "
    "sessions to Backblaze B2, run the on-device MMPose engine to extract 2D/3D "
    "skeleton keypoints, and write per-frame keypoint JSON, skeleton-overlay "
    "PNGs, and a keypoints_index.jsonl dataset manifest back to B2. This "
