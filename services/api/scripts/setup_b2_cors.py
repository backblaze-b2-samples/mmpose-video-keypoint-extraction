...
def _client():
    ...
    # client leaves region unset for object ops. Region comes straight from the
    # configured B2_REGION — no region string is hardcoded here.
    return boto3.client(
        "s3",
        ...
        config=Config(signature_version="s3v4", user_agent_extra="b2ai-mmpose-video-keypoint-extraction"),
    )
